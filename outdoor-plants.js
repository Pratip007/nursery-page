// Outdoor Plants Page JavaScript - Fast Loading Version

// Image folder path
const IMAGE_FOLDER = 'images/outdoor-plants/';

// Generate array of image numbers (1 to 85)
const outdoorPlantImages = Array.from({length: 85}, (_, i) => (i + 1).toString());
...
let filteredImages = [...outdoorPlantImages];
let isLoading = false;
    ...
    return `
        <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 overflow-hidden">
            <div class="relative overflow-hidden cursor-pointer plant-image" 
                 ...
                 data-description="Outdoor plant from our collection">
                <img 
                    ${srcAttr}
...
function preloadCriticalImages() {
    ...
    const criticalImages = outdoorPlantImages.slice(0, 12);
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Only initialize if we're on the outdoor plants page
    if (plantsContainer) {
